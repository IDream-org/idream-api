...
export class CollectionsTable1715625418031 implements MigrationInterface {
    name = 'CollectionsTable1715625418031'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "collections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "image" character varying NOT NULL, "users" jsonb NOT NULL DEFAULT '[]', "categories" character varying, "private" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "authorId" uuid, CONSTRAINT "REL_9054efaa6603a997ac9a0a6032" UNIQUE ("authorId"), CONSTRAINT "PK_21c00b1ebbd41ba1354242c5c4e" PRIMARY KEY ("id"))`);
